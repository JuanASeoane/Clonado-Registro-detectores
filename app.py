...
def get_db_connection():
    """Abre la base de datos SQLite de esta versión de Streamlit Cloud.

    Se mantiene el almacenamiento efímero original; esta función solo
    centraliza la apertura de la conexión para las rutinas que la usan.
    """
        ...
        if resultados_pdf_is47 is not None:
            try:
                ...
                if st.session_state.get(_firma_key_is47) != _firma_pdf_is47:
                    from utils_informe.excel_parser import extraer_resultados_pdf_laboratorio as _extraer_resultados_pdf_laboratorio_is47
                    _resultados_pdf_is47 = _extraer_resultados_pdf_laboratorio_is47(
                    ...
                    if _resultados_pdf_is47.empty:
                        ...
                        if _k_pdf_is47:
                            ...
                            # Guardamos el valor y hacemos un único rerun para
                            # mostrarlo inmediatamente en la casilla.
                            _firma_k_is47 = f"{resultados_pdf_is47.name}_{len(_pdf_bytes_is47)}"
                            _firma_k_key_is47 = f"is47_factor_k_pdf_fid_{cid}"
                            if st.session_state.get(_firma_k_key_is47) != _firma_k_is47:
                                st.session_state[_firma_k_key_is47] = _firma_k_is47
            ...
            try:
                ...
                if resultados_pdf_df.empty:
                    ...
                    if _k_pdf and st.session_state.get(f"ic_factor_k_pdf_fid_{cid}") != _firma_k_pdf:
                        ...
                        # El widget ya está instanciado; preparar el valor y
                        # refrescar una sola vez para verlo inmediatamente.
    ...
    with st.container(border=True):
      if not detectores:
                  ...
                  try:
                      ...
                      with st.spinner("Generando documentos..."):
                          ...
                          if gen_planos_pdf:
                              ...
                              ruta_planos_pdf = os.path.join(get_data_dir(), nombre_planos_pdf)
          ...
          if hay_pdf or hay_planos_pdf or hay_excel or hay_zip or hay_lab:
              ...
              # 3) Descargar plano con detectores ubicados
