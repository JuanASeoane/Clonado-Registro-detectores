...
def delete_centro(centro_id):
    """Elimina centro, datos, carpeta física y temporales asociados."""
    centro = get_centro(centro_id)
    if not centro:
        return False
    nombre_centro = centro[1]
    ...
    carpeta_eliminada = eliminar_carpeta_centro(centro_id, nombre_centro)
    conn = get_db_connection()
    c = conn.cursor()
...
def _crear_componente_camara_detector():
    ...
    a 640x480. Solo se envía al servidor una captura JPEG pequeña.
    """
    html = """
    <div class="radon-camera">
      ...
      <div class="camera-wrap" hidden>
        <video autoplay muted playsinline></video>
        <div class="hint">Centra el código dentro del recuadro</div>
...
def pantalla_centro_detectores():
    ...
    def _ejecutar_accion_detector(accion):
        ...
        if abierto_actual is not None:
            ...
            # código (escrito a mano o leído con la cámara), se conserva el
...
def main():
    ...
    */
    ...
    # Mantener el volumen organizado y visible por usuario/centro.
