...
def _pantalla_informe_is47(cid, centro, variante="A"):
    ...
    with _acordeon_informe("1", "DATOS DE LA EMPRESA Y DEL CENTRO DE TRABAJO", completos_1):
        ...
        with c1:
            ...
            st.text_input("Superficie construida (m²)", value=datos_centro.get("superficie_construida", ""), disabled=True, key=f"is47_supc_{cid}")
        with c2:
            ...
            st.text_input("Superficie útil (m²)", value=datos_centro.get("superficie_util", ""), disabled=True, key=f"is47_supu_{cid}")
        st.caption("Estos datos se editan en Datos del centro y Datos de la empresa.")
